// Static data for Clakett Studio / كلاكيت ستوديو
...
export const PRODUCTS = [
  {
    ...
    isHot: true,
    reviews: [
      { name: 'عبد الرحمن الشمري', stars: 5, comment: 'جبارة جداً وتصويرها تفاصيله مجنونة في ظروف الإضاءة الصعبة.' },
      { name: 'هيثم القحطاني', stars: 5, comment: 'أفضل استثمار لصناعة الفلوجات وتصوير المراجعات بدقة الوان خرافية.' }
    ]
  },
  {
    id: 'p2',
    ...
    isHot: true,
    reviews: [
      { name: 'طلال الرويلي', stars: 5, comment: 'بارد وما يسبب تعرق أبداً، مريح للظهر جداً بعد جلسات ٦ ساعات بث متواصل.' },
      { name: 'رغد صالح', stars: 4, comment: 'الكرسي فخم وألوانه متناسقة مع أي سيت أب قيمنق وبث.' }
    ]
  },
  {
    id: 'p3',
    ...
    reviews: [
      { name: 'منى العسيري', stars: 5, comment: 'الإضاءة ناعمة على العين وتوزيعها مبهر في البث المباشر.' }
    ]
  },
  {
    id: 'p4',
    ...
    reviews: [
      { name: 'فيصل الغامدي', stars: 5, comment: 'استجابة سريعة وملمس الأزرار فخم وتأثيرات الإضاءة روعة.' }
    ]
  },
  {
    id: 'p5',
    ...
    specs: {
      'حجم المحرك': '50 ملم نيوديميوم',
      'الاستجابة الترددية': '15 Hz - 28,000 Hz',
      'المقاومة الكهربائية': '38 أوم',
      'الوزن': '285 جرام'
    },
    reviews: [
      { name: 'عمر مروان', stars: 5, comment: 'نقاوة صوت مذهلة ومريحة جداً للأذن ما تسبب ضغط حتى لو لبستها ساعات طويله.' }
    ]
  },
  {
    id: 'p6',
    ...
    isHot: true,
    reviews: [
      { name: 'صالح القرني', stars: 5, comment: 'خامات تصنع الفارق والصوت فيها دافئ ونقي كأنك في استديو راديو حقيقي.' },
      { name: 'نهال عبد الرحمن', stars: 5, comment: 'عزل الضجيج فيه روعة وخاصية كتم الصوت سريعة وممتازة للبثوث.' }
    ]
  },
  {
    id: 'p7',
    ...
    specs: {
      'الصيغة المتاحة': 'CUBE (LUTs) & WAV (Sound FX 96kHz)',
      'الحجم التقريبي': '2.1 جيجابايت تحميل فوري مفرود',
      'التوافق': 'جافة لجميع برامج المونتاج المعروفة',
      'الترخيص': 'تجاري شخصي مدى الحياة'
    },
    reviews: [
      { name: 'سلطان ممدوح', stars: 5, comment: 'أصوات الهوشات والمؤثرات فخمة وتعطي هيبة للفيديوات!' },
      { name: 'أبرار الصاعدي', stars: 5, comment: 'ألوان الـ LUTs حولت لقطات كاميرا جوالي لكأنها كاميرا احترافية غالية.' }
    ]
  }
];
...
export const FILTER_CATEGORIES = [
  ...
  { id: 'accessories', titleAr: 'مستلزمات قيمنق' },
